...
vi.mock('@/features/max-memory-scale-factor/presentations/MaxMemoryScaleFactor', () => ({
  MaxMemoryScaleFactor: () => (
    <div data-testid="max-memory-scale-factor">Max Memory Scale Factor Component</div>
  ),
}));
...
describe('MaxMemoryScreen', () => {
  it('renders MaxMemoryScaleFactor component', () => {
    ...
    expect(screen.getByText('Max Memory Scale Factor Component')).toBeInTheDocument();
  });
