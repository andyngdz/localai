...
- [x] 2.1 Add IconButton with folder icon next to "Backend Logs" title in `BackendLog.tsx`
- [x] 2.2 Connect IconButton to call `window.electronAPI.backend.openBackendFolder()`

## 3. Testing

- [x] 3.1 Add unit test for the IconButton in `BackendLog.test.tsx`
- [x] 3.2 Update vitest.setup.ts mock for new electronAPI method
